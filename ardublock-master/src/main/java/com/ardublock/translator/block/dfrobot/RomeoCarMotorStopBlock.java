...
public class RomeoCarMotorStopBlock extends TranslatorBlock
{
	
	public RomeoCarMotorStopBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
